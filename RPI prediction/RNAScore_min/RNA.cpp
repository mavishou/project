...
void RNA::stepThird()
{
    ...
    fscore5 = compute_score( humanprotein_5 , ten3 , w5 , fscore1 , len_humanprotein_5 );
...
void RNA::lq( int *score , int len , double *ten )
{
    double tmp = 0 ;
    for( int i = 0 ; i < 10 ; ++i )
    {
...
void RNA::encode2()
{
    ...
    for( int i = 0 ; i < len_RNA_string ; ++i )
    {
        if( RNA_string[i] == 'A')
        {
            score2[len_score2++] = 24;
            score2[len_score2++] = 17;
            score2[len_score2++] = 40;
            score2[len_score2++] = 10;
        }
        else if( RNA_string[i] == 'G' )
        {
            score2[len_score2++] = 21;
            score2[len_score2++] = 86;
            score2[len_score2++] = 17;
            score2[len_score2++] = 41;
            score2[len_score2++] = 29;
        }
        else if( RNA_string[i] == 'C' )
        {
            score2[len_score2++] = 49;
            score2[len_score2++] = 21;
            score2[len_score2++] = 26;
...
void RNA::encode3()
{
    ...
    for( int i = 0 ; i < len_RNA_string ; ++i )
    {
        if( RNA_string[i] == 'A')
        {
            score3[len_score3++] = 79;
            score3[len_score3++] = 98;
            score3[len_score3++] = 69;
            score3[len_score3++] = 40;
            score3[len_score3++] = 53;
            score3[len_score3++] = 37;
            score3[len_score3++] = 84;
            score3[len_score3++] = 62;
            score3[len_score3++] = 49;
            score3[len_score3++] = 28;
        }
        else if( RNA_string[i] == 'G' )
        {
            score3[len_score3++] = 26;
            score3[len_score3++] = 74;
            score3[len_score3++] = 24;
            score3[len_score3++] = 37;
            score3[len_score3++] = 22;
            score3[len_score3++] = 21;
            score3[len_score3++] = 19;
            score3[len_score3++] = 67;
            score3[len_score3++] = 48;
            score3[len_score3++] = 44;
            score3[len_score3++] = 21;
        }
        else if( RNA_string[i] == 'C' )
        {
            score3[len_score3++] = 14;
            score3[len_score3++] = 44;
            score3[len_score3++] = 98;
            score3[len_score3++] = 42;
            score3[len_score3++] = 30;
            score3[len_score3++] = 50;
            score3[len_score3++] = 39;
            score3[len_score3++] = 19;
        }
        else
        {
            score3[len_score3++] = 25;
            score3[len_score3++] = 42;
            score3[len_score3++] = 74;
            score3[len_score3++] = 53;
            score3[len_score3++] = 43;
            score3[len_score3++] = 67;
            score3[len_score3++] = 44;
            score3[len_score3++] = 24;
        }
